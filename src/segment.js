...
export default class Segment {
	...
	intersect(other) {
		 ...
		 */
		let isect = lineIntersect(this.a, this.b, other.a, other.b);
	...
	collinear(other) {
		...
		if (other.a.y - this.a.y - t1 * direction.y >= Constants.EPSILON || other.a.z - this.a.z - t1 * direction.z >= Constants.EPSILON)
			return null;

		let t2 = (other.b.x - this.a.x) / direction.x;
		if (other.b.y - this.a.y - t2 * direction.y >= Constants.EPSILON || other.b.z - this.a.z - t2 * direction.z >= Constants.EPSILON)
			return null;
